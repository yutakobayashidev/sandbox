  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const chatCompletion = await openai.chat.completions.create({
      messages: [
        ...
        { role: "user", content: interaction.options.getString("文字列") },
      ],
      model: "gpt-3.5-turbo",
    });
